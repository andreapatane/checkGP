...
%Here overapproximating K for ReLU kernel. Mot of the work is done in computing the derivative of the function K iteratively on the number of layers...
%optimisation problem is 1-d, and I solve it via golden-section optimisation.
