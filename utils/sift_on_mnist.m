function [feat_pix_cell,magnitudes] = sift_on_mnist(img,maxFeatNum,maxFeatSize)
%
%Using SIFT to comput interesting feature patches.
%
...
[f,d] = vl_sift(img_single,'Levels',20,'EdgeThresh',100,'WindowSize',100) ;
